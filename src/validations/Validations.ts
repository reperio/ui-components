export interface IValidations {
    ...
    GreaterThanOrEqual: (min: number) => (value: any) => string | undefined;
    LessThanOrEqual: (max: number) => (value: any) => string | undefined;
...
export const Validations : IValidations = {
    ...
    GreaterThanOrEqual: min => value => value == null || value < min ? `Must be greater than or equal to ${min}.` : undefined,
    LessThanOrEqual: max => value => value == null || value > max ? `Must be less than or equal to ${max}.` : undefined,
